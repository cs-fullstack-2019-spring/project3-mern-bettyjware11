        ...
        return(
            <div>
                ...
                <Router>
                    ...
                    <Route exact path={"/"} component={()=><TrendingTweetSignIn isLoggedIn={this.state.isLoggedIn} username={this.state.username} tweetTitle={this.state.tweetTitle} loggedInUserInfo={this.loggedInUserInfo}/>} />
