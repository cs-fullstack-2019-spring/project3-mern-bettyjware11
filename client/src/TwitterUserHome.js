        ...
        return(
            <div>
                ...
                <Router>
                    ...
                    <Route exact path={"/"} component={()=><TwitterSignIn isLoggedIn={this.state.isLoggedIn} username={this.state.username} tweet={this.state.tweet} loggedInUserInfo={this.loggedInUserInfo}/>} />
