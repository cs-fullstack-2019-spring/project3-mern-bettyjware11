...
passport.deserializeUser(function(id, done) {
    UserEmailCollection.findById(id, function(err, user) {
        done(err, user);
    });
});

// Validation for password. The password in the function is what the user entered. The user.password is the saved password. It's run when someone needs to log in and check if the password they entered is the same as the one in the database.
